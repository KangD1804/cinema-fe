...
export default function Movie() {
  ...
  const renderDanhSachPhim = () => {
    return danhSachPhim
      ...
      .map((phim, index) => {
        return (
          <TableRow hover role="checkbox" tabIndex={-1} key={phim.movieId}>
            <TableCell>{phim.movieId}</TableCell>
            <TableCell>{phim.movieTitle}</TableCell>
            <TableCell>{phim.alias}</TableCell>
            <TableCell>
              <img
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div className="edit-action mr-2">
                  <i
                    ...
                    data-toggle="modal"
                    data-target={`#d${phim.movieId}`}
                  ></i>
                </div>
                <EditMovieModal movie={phim} />
